...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greeter_3b2f7dde8111f3c1, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_greeter_3b2f7dde8111f3c1, []int{1}
}
...
func (c *greeterClient) SayHi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/proto.Greeter/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Greeter/SayHi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("greeter.proto", fileDescriptor_greeter_3b2f7dde8111f3c1) }

var fileDescriptor_greeter_3b2f7dde8111f3c1 = []byte{
	...
	0x3a, 0x4c, 0x11, 0x8c, 0x6b, 0x54, 0xc4, 0xc5, 0xee, 0x0e, 0xb1, 0x43, 0xc8, 0x84, 0x8b, 0x23,
	0x38, 0xb1, 0x12, 0xac, 0x4b, 0x48, 0x18, 0x62, 0xa3, 0x1e, 0xb2, 0x3d, 0x52, 0x82, 0xa8, 0x82,
	0x05, 0x39, 0x95, 0x4a, 0x0c, 0x42, 0x86, 0x5c, 0xac, 0x20, 0x5d, 0x99, 0xc4, 0x6b, 0x49, 0x62,
	0x03, 0x8b, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xa2, 0xea, 0xc4, 0x3d, 0xde, 0x00, 0x00,
	0x00,
}
